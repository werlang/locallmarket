...
CREATE TABLE IF NOT EXISTS workers (
    ...
    uptime_window_started_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    uptime_24h_seconds INT UNSIGNED NOT NULL DEFAULT 0,
    served_window_started_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    served_requests_24h INT UNSIGNED NOT NULL DEFAULT 0,
    reputation DECIMAL(10, 6) NOT NULL DEFAULT 0,
